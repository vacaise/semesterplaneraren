...
const Index = () => {
  ...
  const generateOptimizedSchedule = () => {
    ...
    try {
      ...
      console.log("Generating schedule with company days:", companyDays);
      const optimizedScheduleData = optimizeVacation(year, vacationDays, holidays, companyDays, selectedMode);
